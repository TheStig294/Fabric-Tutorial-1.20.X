...
import net.thestig294.tutorialmod.entity.animation.ModAnimations;
import net.thestig294.tutorialmod.entity.custom.PorcupineEntity;

//
// Declares the model, and uses declared animations
//
...
//		How do you know the ID names for getting the head? Look at the Blockbench file's object tree!
...
//		*Very important to always have this line in this function first!*
//		(Otherwise, each model group is going to be left transformed if the animation doesn't return the model to a complete neutral position,
//		and animations will start looking very weird, very quick!)
...
//	Rotates the head to the appropriate angle when looking at an entity, or looking around
